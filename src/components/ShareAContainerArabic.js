...
export default function ShareAContainer() {
   ...
   const url3=`http://localhost:8080/findpostload/${point_of_loading}`
        ...
        var SubscriptionDate2 = new Date(subscriptionDate1);
         ...
         var Difference_In_Days = Difference_In_Time / (1000 * 3600 * 24);
          if (Difference_In_Days > 30) {
             ...
             history.push('./sharecontainer-arabic');
        }
    ...
    return (
        <div id='shareContainerComponent'>
            <div id='shareModule'>
                ...
                <h4>LCL</h4>
                <div id='label'>اكتب التفاصيل الخاصة بك
</div>
                <div id='label'>سوف نجد الشاحن وفقا لمتطلباتك
</div>
              ...
              >
                ...
                <div class="input-field col s6" id='div-input'>
                    ...
                    <label for="phone_No">رقم الهاتف
</label></div>
                </div>
                <div class="input-field col s6" id='div-input'>
                    <input id="date_of_uploading" type="date" class="validate" value={date_of_uploading}  onChange={onChangeDOU}/>
                    <label for="date_of_uploading">تاريخ الرفع
</label>
                </div>
                <Button value="Submit" variant="outlined"  color="success" id="Search-Submit" disabled={disabledValue} onClick={Search}>البحث والنشر
</Button>
