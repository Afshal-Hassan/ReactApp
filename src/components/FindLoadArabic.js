    ...
    return (
        <div className='FindLoadModule'>
            ...
            <ButtonGroup variant="outlined" aria-label="outlined button group" id="ButtonGroupAllPost">
                    <Button id='buttonGroup1'color='primary' variant='outlined'><Link to="/postload-arabic" id='link1'>نشر حاوية ممتلئة
</Link></Button>
                    <Button id="buttonLCL" color='warning' variant='outlined'><Link to="/sharecontainer-arabic" id='link2'>حاوية مشاركة المشاركة
</Link></Button>
                </ButtonGroup>
                <h1 id='FindLoad-h1'>بعد تحميل</h1>
                <h4>FCL</h4>
                <form id='postLoadForm' onSubmit={SubmitLoad}>
                    <input type='text' placeholder='نوع السيارة على سبيل المثال (راجع 40 قدمًا)
' name='vehicle' onChange={onchangeVehicle} value={vehicle} id="name" />
                    <input type='text' placeholder='نقطة التحميل
' name='Pol' onChange={onchangePointOfLoading} value={pointOfLoading} id="location" />
                    <input type='text' placeholder='نقطة التسليم' name='Pod' onChange={onchangePointOfDelivery} value={pointOfDelivery} id="shipper-name" />
                    <input type='text' placeholder='وزن المنتج (كجم)' name='Pw' onChange={onchangeProductWeight} value={productWeight} id="product-weight" />
...
' name='Pn' onChange={onchangePhoneNo} value={phoneNo} id="phone-no" /></div>
...
' name='shipper-email' value={shipperEmail} onChange={onchangeShipperEmail} id="shipperEmail" />
                    ...
                    <Button id='buttonGroup1Post'color='primary' variant='outlined'type='submit'>يُقدِّم</Button>
                </form>
            </div>
            <ToastContainer />
